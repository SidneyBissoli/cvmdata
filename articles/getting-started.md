...
catching in your own code. Live chunks use the default mirror backend
(GitHub Releases + DuckDB); the CVM Open Data Portal backend is
documented alongside the mirror in its own article.
