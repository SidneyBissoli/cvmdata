...
é funcional e cobre v0.1–v0.2 (grupo `companhias`); v0.3 em diante
estende a cobertura. Os outros 4 são skeletons exportados que abortam
com `cvmdata_error_input_group`, com implementação plena em v0.4–v0.8.
Skeletons foram exportados antes da implementação para **travar a
superfície da API pública cedo**, de modo que as releases v0.4+ estendam
cobertura sem reformatar a API.
