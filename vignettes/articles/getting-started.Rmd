...
v0.1.0.9000 implements six datasets in the `companhias` group:
`cad`, `dfp`, `itr`, `fre` (v0.1) and `cgvn`, `vlmo` (added toward
v0.2). The examples below are marked `eval = FALSE` to keep the
