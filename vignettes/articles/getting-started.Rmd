...
worth catching in your own code. Live chunks pin
`source = "cvm"` (the CVM Open Data Portal) so the examples work
without the mirror release index; the mirror backend is documented in
its own article.
