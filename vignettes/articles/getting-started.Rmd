...
## Fetching data — a tour of the 7 issuer datasets

v0.1.0.9000 implements seven datasets in the `companhias` group:
`cad`, `dfp`, `itr`, `fre` (v0.1) and `cgvn`, `vlmo`, `fca` (added
